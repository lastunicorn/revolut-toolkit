...
internal sealed class TransactionCurrencyConverter : DefaultTypeConverter
{
    public override object ConvertFromString(string text, IReaderRow row, MemberMapData memberMapData)
    {
        ...
        try
        {
            return new TransactionCurrency(text);
        }
    ...
    {
        return value is TransactionCurrency transactionCurrency
